...
WS_HEARTBEAT_INTERVAL = 30  # Heartbeat/ping interval (seconds) — the SOLE dead-connection detector; there is deliberately no receive() timeout (see DEVELOPMENT.md)
