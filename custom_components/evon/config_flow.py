...
# NOTE: The repair fix flow (EvonStaleEntitiesRepairFlow / async_create_fix_flow)
# lives in repairs.py — Home Assistant discovers fix flows only from the
# <domain>/repairs.py platform module, not from config_flow.py.
